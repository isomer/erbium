    ...
    crates = {
      ...
      "erbium" = rec {
        ...
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/erbium; }
          else ./crates/erbium;
        build = "src/build.rs";
        authors = [
      ...
      "erbium-core" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/erbium-core; }
          else ./crates/erbium-core;
        libName = "erbium";
        authors = [
          "Perry Lorier <git@isomer.meta.net.nz>"
        ];
      ...
      "erbium-net" = rec {
        ...
        # See https://github.com/NixOS/nix/issues/5410
        src = if ((lib.versionOlder builtins.nixVersion "2.4pre20211007") || (lib.versionOlder "2.5" builtins.nixVersion ))
          then lib.cleanSourceWith { filter = sourceFilter;  src = ./crates/erbium-net; }
          else ./crates/erbium-net;
        authors = [
          "Perry Lorier <git@isomer.meta.net.nz>"
        ];
        dependencies = [
